...
class FileManagerApp(Tk):
    def __init__(self):
        super().__init__()
        self.title("Sistema de Gerenciamento de Arquivos v6.4")
    ...
    def show_login_frame(self):
        ...
        self.title("Sistema de Gerenciamento de Arquivos v6.4 - Login")
    ...
    def show_main_app_frame(self):
        for widget in self.container.winfo_children(): widget.destroy()
        self.title(f"Sistema de Gerenciamento de Arquivos v6.4 - Logado como: {self.current_user} ({self.user_role})")
